...
# React Native Internship Training Program
...
P/s: Bài viết chủ yếu dựa trên tài liệu chính thống của React-Native phiên bản 0.59 tại <https://facebook.github.io/react-native/docs/getting-started> kết hợp với sự hiểu biết cá nhân của mình vì vậy nếu có sai sót, anh em cứ góp ý để mình sửa đổi nhé.

# Một Số Câu Hỏi Phỏng Vấn Javascript
[Javascript Interview Questions](./javascript-interview-questions.md)
# Mục Lục
